...
Here is the component once again. You can find this exercise in the `completed-components/exercise-5-tests` directory and [on GitHub](https://github.com/marcysutton/frontend-masters-enterprise-accessibility/tree/main/completed-components/exercise-5-tests).
