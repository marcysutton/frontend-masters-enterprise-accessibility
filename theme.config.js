const theme = {
	...
	head: function Head(props) {
		return (
			<>
				...
				<meta property="og:url" content="https://enterprise-accessibility.vercel.app/topics" />
				<meta property="og:type" content="website" />
				<meta property="og:locale" content="en_US" />
				<meta property="og:image:width" content="1200" />
				<meta property="og:image:height" content="692" />
				<meta property="og:title" content={`${props.title} | Enterprise Accessibility`} />
				<meta
					property="og:description"
					content="Website created for the FrontendMasters course on Enterprise Accessibility by Marcy Sutton Todd"
				/>
				<meta property="og:image" content="https://enterprise-accessibility.vercel.app/ogimage1.png" />
	...
	useNextSeoProps() {
		return {
			titleTemplate: '%s – Enterprise Accessibility',
		};
	},
};
